# --- The MIT License (MIT) Copyright (c) alvinlin, Fri May 2nd 03:21:00 2020 ---
...
def appProcedure():
    ...
    logging.info('全部數量: %s 個. ' % listedTasksTotal)
    if downloadingTasks:
    ...
    if otherTasks:
        logging.info('其他未知: %s 個. ' % len(otherTasks))            
...
if __name__ == '__main__':
    ...
    if nasConfig:
        ...
        if ds214se.login:      
            ...
            for i, j in enumerate(nasDownloading):
