...
if __name__ == '__main__':
    ...
    # ## --- 特殊情況則直接讀入今天已完成的資料檔, 然後確定總數量 -----------------------------   
    # if pttBeautyCrawler.getJustCompletedBeautyPickle()
    #     myLineNotificator.sendMessage('[%s]已讀取今天可用的資料檔，共有筆[%d]資料' % (pttBeautyCrawler.name, pttBeautyCrawler.itemCounter))
    # ---- 啟始記錄檔 --------------------------
